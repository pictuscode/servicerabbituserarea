			...
			<div class="servicer_detail_base">
                     <div class="container">
                            <div class="service_detail_inner">
                                    <h1><?php echo get_common_details(CMS_DETAILS,'title',$content1->row()->id,$lang_key);?></h1>
                                    <div>
										<?php echo  html_entity_decode(get_common_details(CMS_DETAILS,'content',$content1->row()->id,$lang_key));?>
									</div>
                            </div>
                     </div>   
			</div>
