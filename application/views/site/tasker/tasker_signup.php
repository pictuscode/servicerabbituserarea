			...
			<div class="container">
				<div class="col-md-12 col-sm-12 col-xs-12 text-center nopadd">
					<div class="col-md-5 col-sm-8 col-xs-12 sign_start nopadd">
						<div class="sign_base ">
							 <?php
								$attributes = array('method' => 'post', 'id' => 'tasker-register-form', 'novalidate' => 'novalidate');
								echo form_open('#', $attributes); ?>
							    <input type="text" name="first_name" id="sfirst_name" placeholder="<?php echo get_lang_site_key($lang_key,"common_lang","first_name"); ?>" class="form-control">
								<input type="text" name="last_name" id="slast_name"  placeholder="<?php echo get_lang_site_key($lang_key,"common_lang","last_name"); ?>" class="form-control">
								<input type="email" name="email" placeholder="<?php echo get_lang_site_key($lang_key,"common_lang","email"); ?>" class="form-control">
								<input type="password" name="password" placeholder="<?php echo get_lang_site_key($lang_key,"common_lang","password"); ?>" class="form-control">
								<input type="text" name="zipcode" id="address_zip" placeholder="<?php echo get_lang_site_key($lang_key,"common_lang","post_code"); ?>" class="form-control">
								<input type="submit" value="<?php echo get_lang_site_key($lang_key,"common_lang","create_account"); ?>" class="submit_btn">
								<p class="agree_terms"><?php echo get_lang_site_key($lang_key,"common_lang","agree"); ?> <a href="<?php echo base_url();?>page/terms-and-conditons"> <?php echo get_lang_site_key($lang_key,"common_lang","terms"); ?> </a> <?php echo get_lang_site_key($lang_key,"common_lang","and"); ?> <a href="<?php echo base_url();?>page/privacy-policy"> <?php echo get_lang_site_key($lang_key,"common_lang","policy"); ?> </a></p>
							</form>    
						</div>
						<div class="sign_logo">
