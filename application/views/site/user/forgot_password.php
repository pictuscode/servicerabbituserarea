					...
					<div class="sign_base sign_in">
						<?php
							...
							echo form_open('#', $attributes); ?>
								...
								<input type="email" name="login_email" placeholder="<?php echo get_lang_site_key($lang_key,"common_lang","email"); ?>" class="form-control">
								<input type="submit" value="<?php echo get_lang_site_key($lang_key,"common_lang","submit"); ?>" class="submit_btn">
						</form>
						<div class="clearfix"></div>
						<span class="under_line sign_line">&nbsp;</span>
						<h4><?php echo get_lang_site_key($lang_key,"common_lang","ihave_account"); ?>? </h4>
						<p><a href="<?php echo base_url();?>user_login"><?php echo get_lang_site_key($lang_key,"header_footer_lang","login"); ?></a></p>
