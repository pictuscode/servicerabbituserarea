...
class Cms extends CI_Controller
{
	...
	{
		$this->data['content1'] = $this->landing_model->get_all_details(CMS, array('url' => $value));
	...
	public function services()
	{
		...
		$this->data['content1'] = $this->landing_model->get_all_details(TASKER_CATEGORY, array('id' => $id));
		if ($this->data['content1']->num_rows() > 0) {
